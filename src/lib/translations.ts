...
export const locales = {
  es: {
    nav: { home: "Inicio", essence: "Esencia", methodology: "Metodología", admissions: "Admisiones", library: "Biblioteca", civic: "Rincón Cívico", portal: "Portal Padres" },
    hero: {
  ...
  qu: {
    nav: { home: "Qallariy", essence: "Yachayninchik", methodology: "Yachachiy Ñan", admissions: "Qillqakuy", library: "Ñawinchana Wasi", civic: "Llaqta Taki", portal: "Tayta-Mamakuna" },
    hero: {
